                                    ...
                                    <div class="col-md-8 offset-md-2">
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="custom-file input-group-lg">
                                                        <input required type="text" autocomplete="off" class="form-control numeric-only" name="ced" id="ced" placeholder="introduzca la cédula del cliente." value="{{$client->ced}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="custom-file input-group-lg">
                                                        <input required type="text" autocomplete="off" class="form-control capitalize" name="name" id="name" placeholder="introduzca los nombres del cliente." value="{{$client->name}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="custom-file input-group-lg">
                                                        <input required type="text" autocomplete="off" class="form-control capitalize" name="lastname" id="lastname" placeholder="introduzca los apellidos del cliente." value="{{$client->lastname}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="custom-file input-group-lg">
                                                        <textarea class="form-control mayus" name="address" id="address" placeholder="introduzca la dirección del cliente.">{{$client->address}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
